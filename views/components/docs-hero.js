...
export default class DocsHero extends TemplateElement {
	template() {
		return html`
					...
					>
						<div class="relative z-10 md:text-center lg:text-left">
							<img
								...
								src="/assets/images/blur-cyan.png"
							/>
							<div class="relative">
								<p
								...
								<p class="mt-3 text-2xl tracking-tight text-slate-400">
									element-js lets you write simple, declarative and beautiful web components without
									the boilerplate.
								</p>
						...
						<div class="relative lg:static xl:pl-10">
							...
							>
								...
								>
									...
									<g opacity=".4" clip-path="url(#:r2b:-clip-path)" stroke-width="4">
										<path
											opacity=".3"
							...
							<div class="relative">
								...
								/><img
									...
									style="color: transparent;"
									src="/assets/images/blur-indigo.png"
								/>
								<div
									...
									<div class="pl-4 pt-4">
										<div class="flex space-x-2 text-xs">
											...
											<div class="flex h-6 rounded-full text-slate-500">
												<div class="flex items-center rounded-full px-2.5">luna.config.js</div>
											</div>
										</div>
										<div class="mt-6 flex items-start px-1 text-sm">
											...
											<pre class="prism-code language flex overflow-x-auto pb-6">
												${unsafeHTML(
												'<code class="px-4"><div class="token-line"><span class="token keyword module">export</span><span class="token plain"> </span><span class="token keyword module">default</span><span class="token plain"> </span><span class="token punctuation">{</span><span class="token plain"></span></div><div class="token-line"><span class="token plain">  </span><span class="token literal-property property">name</span><span class="token operator">:</span><span class="token plain"> </span><span class="token string">\'@webtides/element-js\'</span><span class="token punctuation">,</span><span class="token plain"></span></div><div class="token-line"><span class="token plain">  </span><span class="token literal-property property">features</span><span class="token operator">:</span><span class="token plain"> </span><span class="token punctuation">{</span><span class="token plain"></span></div><div class="token-line"><span class="token plain">    </span><span class="token literal-property property">simple</span><span class="token operator">:</span><span class="token plain"> </span><span class="token number">true</span><span class="token punctuation">,</span><span class="token plain"></span></div><div class="token-line"><span class="token plain">    </span><span class="token literal-property property">fast</span><span class="token operator">:</span><span class="token plain"> </span><span class="token punctuation">[</span><span class="token string">\'almost lightning fast\'</span><span class="token punctuation">]</span><span class="token punctuation">,</span><span class="token plain"></span></div><div class="token-line"><span class="token plain">  </span><span class="token punctuation">}</span><span class="token punctuation">,</span><span class="token plain"></span></div><div class="token-line"><span class="token plain"></span><span class="token punctuation">}</span></div></code>',
												)}
											</pre
											>
										</div>
